...
export default class UserValidators {
  ...
  static registerUserValidator = [
    ...
    body("username", "No username entered.")
      ...
      .withMessage(
        "Please enter a username that is between 7 and 30 characters long."
      )
      .escape(),
    ...
    body("passwordConfirm")
      ...
      .isLength({ min: 7, max: 30 })
      .withMessage(
        "Please enter a password that is between 7 and 30 characters long."
      )
      .custom(
    ...
    body("fname")
      ...
      .isAlpha()
      .withMessage(
        "Only alphabetical characters are allowed in the name field."
      ),
  ...
  static updateUserInfoValidator = [
    ...
    body(
      "user",
      "Invalid characters in the user ID. What are you trying to do here?"
    )
      .trim()
      .escape(),
  ...
  static deleteClientValidator = [
    ...
    body("clientID", "Invalid client ID provided to the server")
      .trim()
      .escape(),
  ];
