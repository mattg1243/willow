...
import { IRegisterUserReqBody, IUpdateUserReqBody, IUpdateClientReqBody, IAddNewClientReqBody, IDeleteEventReqBody, IResetPasswordReqBody, ISetNewPasswordReqBody } from './reqTypes';
...
export default class UserHandlers {
    ...
    static addNewClient = async (req: Request<ParamsDictionary, {}, IAddNewClientReqBody>, res: Response): Promise<Response> => {
    ...
    static deleteClient = async (req: Request<ParamsDictionary, {}, IDeleteEventReqBody>, res: Response): Promise<Response> => {
        try {
    ...
    static updateClientInfo = async (req: Request<ParamsDictionary, {}, IUpdateClientReqBody>, res: Response): Promise<Response> => {
